...
public class ConnectionPanel extends JPanel {
    ...
    private void initGUI() {
        ...
        saveButton.addActionListener(e -> {
            ...
            ConnectionConfig connectionConfig = switch (driverComboBox.getSelectedItem()) {
                case JDBCDriver.MYSQL -> new MySQLConnectionConfig(
                    hostTextField.getText(), databaseTextField.getText(), userTextField.getText(), String.valueOf(passwordField.getPassword())
                );
                case JDBCDriver.POSTGRESQL -> new PostgreSQLConnectionConfig(
                    hostTextField.getText(), databaseTextField.getText(), userTextField.getText(), String.valueOf(passwordField.getPassword())
                );
                case JDBCDriver.ORACLE -> new OracleConnectionConfig(
                    hostTextField.getText(), databaseTextField.getText(), userTextField.getText(), String.valueOf(passwordField.getPassword())
                );
                default -> throw new IllegalStateException("Unexpected value: " + driverComboBox.getSelectedItem());
            };
